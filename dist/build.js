...
var productSlider = new _slider2.default({
    el: ".news__content",
...
var _sliderItem = __webpack_require__(4);

var _sliderItem2 = _interopRequireDefault(_sliderItem);

var _sliderIndicators = __webpack_require__(5);

var _sliderIndicators2 = _interopRequireDefault(_sliderIndicators);
...
var Slider = function () {
    function Slider(options) {
        ...
        this.getSlides().then(function (slides) {
            ...
            _this.initElements();
            _this.initStyle();
            _bus2.default.$emit('sliderMoved', {
                currentSlide: 0
            });
        });
    }
    ...
    _createClass(Slider, [{
        ...
        value: function initEvents() {
            ...
            _bus2.default.$on('sliderMovedIndicator', this.sliderMovedIndicator.bind(this));
        ...
        value: function initComponents(slides) {
            ...
            slides.forEach(function (slide, index) {
                ...
                var newSlide = new _sliderItem2.default(slide);
                _this3.slides.push(newSlide);
            });

            this.sliderIndicators = new _sliderIndicators2.default({
                slides: this.slides
            });
        }
    }, {
        ...
        value: function initElements() {
            this.htmlSlides = [].concat(_toConsumableArray(this.el.querySelectorAll('.slider__slide'))).reverse();
            for (var slide in this.htmlSlides) {
        ...
        value: function move(dir) {
            ...
            var tl = new _gsap.TimelineMax({
                ...
                onStart: function onStart() {
                    _bus2.default.$emit('sliderMoved', {
                        currentSlide: _this4.slides[_this4.currentSlide + 1].props.id
                    });
                    _this4.animating = true;
                },
                onComplete: function onComplete() {

                    _this4.slides.move(_this4.currentSlide, _this4.slides.length - 1);
        ...
        value: function render() {
            ...
            this.template = "\n            \n                <button class=\"slider__control slider__left-control\">\n                    <img src=\"./icons/components/slider/left_control.png\" alt=\"\">\n                </button>\n                <div class=\"slider__wrapper\">\n                    <div class=\"slider__interface\">\n                        <div class=\"slider__content\">\n                             " + this.slides.map(function (slide, index) {
                return slide.el.outerHTML.trim();
...
var _sliderIndicator = __webpack_require__(6);

var _sliderIndicator2 = _interopRequireDefault(_sliderIndicator);
...
var SliderIndicators = function () {
    function SliderIndicators(props) {
        _classCallCheck(this, SliderIndicators);
        ...
        try {
            for (var _iterator = this.props.slides[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var slide = _step.value;


                var newIndicator = new _sliderIndicator2.default(slide.props);
    ...
    _createClass(SliderIndicators, [{
        ...
        value: function render() {
            ...
            this.template = '\n          \n            <div class="slider__indicators__wrapper">\n                ' + this.indicators.map(function (indicator, index) {
                return indicator.el.outerHTML.trim();
            }).join('') + '\n            </div>\n            \n            ';
...
exports.default = SliderIndicators;
...
var SliderIndicator = function () {
    ...
    _createClass(SliderIndicator, [{
        key: 'initEvents',
        value: function initEvents() {
            var indicator = document.querySelectorAll('.slider__indicators__indicator')[this.props.id];
            indicator.addEventListener('click', this.move.bind(this));
            _bus2.default.$on('sliderMoved', this.sliderMoved.bind(this));
        }
    }, {
        key: 'sliderMoved',
        ...
        key: 'move',
        value: function move() {
            _bus2.default.$emit('sliderMovedIndicator', {
...
exports.default = SliderIndicator;
